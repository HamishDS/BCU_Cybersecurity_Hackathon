...
if __name__ == "__main__":
    # Minimal in-memory scenarios to sanity-check the detector.
    now = datetime.now()



    # 2) Clear scan: many distinct ports within 60s
    ...
    alerts = detect_port_scan(all_logs)
    print(f"Self-test: produced {len(alerts)} alert(s)")
    for a in alerts:
        print(a)
